...
var _require = require("sequelize"),
  Op = _require.Op;
var MAX_NUMBERS_SCHEDULE = process.env.MAX_NUMBERS_SCHEDULE;
var getTopDoctorHome = function getTopDoctorHome() {
...
var saveInfoDoctor = function saveInfoDoctor(inputData) {
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            if (!(!inputData.doctorId || !inputData.contentHtml || !inputData.contentMarkdown || !inputData.action || !inputData.selectedPrice || !inputData.selectedProvince || !inputData.selectedPayment || !inputData.addressClinic || !inputData.nameClinic || !inputData.note || !inputData.specialtyId)) {
              _context3.next = 5;
              break;
            }
            resolve({
          ...
          case 22:
            ...
            doctorInfo.specialtyId = inputData.specialtyId, doctorInfo.clinicId = inputData.clinicId;
            _context3.next = 34;
...
var getDoctorById = function getDoctorById(inputId) {
  return new Promise( /*#__PURE__*/function () {
...
var saveBulkCreateSchedule = function saveBulkCreateSchedule(data) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 9:
            ...
            toCreate = _.differenceWith(schedule, existing, function (a, b) {
...
var getScheduleDate = function getScheduleDate(doctorId, date) {
  return new Promise( /*#__PURE__*/function () {
...
var getListPatient = function getListPatient(doctorId, date) {
  return new Promise( /*#__PURE__*/function () {
...
var postSendRemedy = function postSendRemedy(data) {
  return new Promise( /*#__PURE__*/function () {
...
var getExtraInfoById = function getExtraInfoById(inputId) {
  return new Promise( /*#__PURE__*/function () {
